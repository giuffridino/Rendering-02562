...
async function main()
{
    ...
    // myHDR.src = '2D_textures/rural_asphalt_road_4k.hdr';
    // myHDR.onload = function() {
    //   myHDR.toHDRBlob(function(blob){
    //     var a = document.createElement('a');
    //     a.href = URL.createObjectURL(blob);
    //     a.download = 'rural_asphalt_hdr.png';
    ...
    textures.env = await load_texture(device, "2D_textures/rural_asphalt_hdr.png");
